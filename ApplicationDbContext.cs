    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Enrollee>().HasData(
                ...
                new Enrollee { Id = 2, Name = "Багаев Тимур Рамазанович" },    
                new Enrollee { Id = 3, Name = "Булискерия Будимир Бакуриевич" },    
                new Enrollee { Id = 4, Name = "Жидков Георгий Сергеевич" },    
                new Enrollee { Id = 5, Name = "Захаренков Милан Двухподвесович" },    
                new Enrollee { Id = 6, Name = "Егоров Семен Фиксрович" },    
            ...
            modelBuilder.Entity<Achievement>().HasData(
                ...
                new Achievement { Id = 5, Name = "МСК по пдъему на бицепс", Bonus = 10 }
            );
